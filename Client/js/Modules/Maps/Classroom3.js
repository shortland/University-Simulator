...
function preload() {
  ...
  this.load.image("Indoor2", "assets/tilesets/Indoor2.png");
  this.load.image("signs", "assets/tilesets/signs.png");
  
  this.load.tilemapTiledJSON("Classroom", "assets/tilemaps/Classroom3.json");
...
function create() {
  ...
  const indoorSet2 = map.addTilesetImage("Indoor2", "Indoor2");
  ...
  let allTileSets = [indoorSet, signsSet, indoorSet2];
